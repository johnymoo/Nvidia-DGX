...
OUT = Path('/home/YOUR_USERNAME/project/nvidia-dgx/qwen36-dgx-spark/benchmark_outputs')
OUT.mkdir(parents=True, exist_ok=True)
TS = datetime.now().strftime('%Y%m%d-%H%M%S')

# Inputs
BENCH_BASE = Path('/home/YOUR_USERNAME/benchmark_results_20260422_133739.json')
BENCH_PR = Path('/home/YOUR_USERNAME/benchmark_results_20260423_053539.json')
BENCH_NV = Path('/home/YOUR_USERNAME/benchmark_results_nvfp4_20260618_062149.json')
...
md.append('')
md.append('## 文件')
for p in [LONG_FP8, LONG_NV, QUAL_FP8, QUAL_NV, Path('/home/YOUR_USERNAME/benchmark_results_nvfp4_20260618_062149.json')]:
    md.append(f'- `{p}`')
md_text='\n'.join(md)
