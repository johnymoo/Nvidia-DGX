...
Based on /home/YOUR_USERNAME/benchmark_vllm_qwen36.py; same prompts/configs/runs for comparability.
"""
...
def main():
    ...
    output_file = f"/home/YOUR_USERNAME/benchmark_results_nvfp4_{timestamp}.json"
