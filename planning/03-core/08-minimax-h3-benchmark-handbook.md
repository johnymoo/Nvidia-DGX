...
Run `20260812T230850Z` used the frozen `showcase` profile: 512x320, 33 model
frames, six sampling steps, and 24 fps video output. All nine formal cases
...
- `/home/admin/minimax-h3-benchmark/artifacts/runs/20260812T230850Z/benchmark.json`
...
An earlier run, `20260812T230652Z`, retained successful media for all three
...
The published pages were verified at 1440x900 and 390x844. Ten video elements
loaded with ready state and native dimensions 512x320; the evidence page showed
