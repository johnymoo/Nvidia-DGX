...
Choose the hardware class that matches the machine, then select an exact model
and runtime profile from the generated recipe catalog. Results are comparable
only within the identities and suite versions stated by each record.
