...
const ACTIVE_TASK_KEY='podcastAsr.activeTaskId', LAST_TASK_KEY='podcastAsr.lastTaskId', LAST_URL_KEY='podcastAsr.lastEpisodeUrl', REFRESHED_TASK_KEY='podcastAsr.refreshedTaskId';
