...
- 12 V 插座、FAN1/FAN2 接头是否外露仍为开放决定；当前 draft 使用一个统一的接头可见性开关，位置和开孔方案以实物复核为准。
...
| Type-C 前框侧槽 | 暂按 20 mm 有效宽度 | `provisional` | 让插头和 12 mm keep-out 从前框左柱侧向出线，需实物插拔复核 |
| 电源侧共用出线槽 | 暂按 24 × 18 mm | `provisional` | 同时容纳 DC 与 FAN 线束穿过托盘左侧墙，需实物插拔复核 |
