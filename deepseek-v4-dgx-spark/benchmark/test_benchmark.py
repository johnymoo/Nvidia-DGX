...
REPORTER_PATH = Path(__file__).with_name("render_report.py")
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="claude-pilot-test-") as raw:
        ...
        os.environ["CLAUDE_DS_BASE_URL"] = "http://127.0.0.1:18001"
        os.environ["PRIVATE_DS_BASE_URL"] = "http://127.0.0.1:18002"
        os.environ["QWEN_LOCAL_BASE_URL"] = "http://127.0.0.1:18003"
        ...
        chained = {"preflight_key": "new", "preflight_migrations": [{"old_preflight_key": "original", "new_preflight_key": "old", "new_runner_sha256": "runner-old"}, {"old_preflight_key": "old", "new_preflight_key": "new", "new_runner_sha256": "runner-new"}]}
        ...
        os.environ.pop("CLAUDE_DS_BASE_URL")
        os.environ.pop("PRIVATE_DS_BASE_URL")
        os.environ.pop("QWEN_LOCAL_BASE_URL")
