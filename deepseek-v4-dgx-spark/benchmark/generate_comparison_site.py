...
<section id="evidence"><div class="shell"><div class="section-head"><div><span class="section-index">07 / EVIDENCE</span><h2>方法与证据</h2></div></div><div class="evidence"><ul><li>主表只展示实际完整完成的配置。</li><li>旧 Private Low/High/Max 均为 effective High；87.5% 不是 Max 精度。</li><li>Portal 修复后，无 override 的 Max 探针与 direct usage、输出哈希一致。</li><li>Private 请求通过 Synology 反代、LLM Portal/LiteLLM 与 WireGuard 到 vLLM，不是直连。</li><li>384K Portal/direct 各 18 请求，均 18/18 stop、0 错误、0 截断。</li><li>Python final 在不可变 ECR sandbox 中评分，原始证据不覆盖。</li><li>Private Max 384K route A/B 与 Agent n=1，其余质量组 n=2。</li></ul><div class="links"><a href="BENCHMARK-COMPARISON-20260817.md">完整 Markdown 报告 <span>↗</span></a><a href="data/deepseek-private-online-comparison-20260817.json">机器可读汇总 <span>↗</span></a><a href="https://github.com/johnymoo/Nvidia-DGX/pull/32">GitHub PR 32 <span>↗</span></a><a href="https://github.com/shiliai/LLM-Portal/issues/46">LLM Portal Issue 46 <span>↗</span></a></div></div></div></section>
