...
<section id="coverage"><div class="shell"><div class="section-head"><div><span class="section-index">05 / TEST COVERAGE</span><h2>本轮覆盖范围</h2><p>“未完成”表示没有可比证据，不以旧错误 treatment 代填。</p></div></div><div class="table-wrap"><table><thead><tr><th>维度</th><th>本轮纳入</th><th>未覆盖</th><th>状态</th></tr></thead><tbody><tr><th>可执行精度</th><td>Private High 32K；High/True Max 4K；True Max 384K Portal/direct；Online Flash/Pro</td><td>384K route A/B 仅 n=1</td><td><span class="status pass">主要边界完整</span></td></tr><tr><th>串行 SSE 性能</th><td>Verified Private High/Max；Online Flash Low；Online Pro Low/High/Max</td><td>Online Flash High/Max</td><td><span class="status pass">主要路径完整</span></td></tr><tr><th>Token 与 API 成本</th><td>Online Pro Low/High/Max</td><td>Private 无 API 账单；Flash 未统一计价</td><td><span class="status pass">范围内完整</span></td></tr><tr><th>Agent 聚焦任务</th><td>Online Pro High；Online/Private 历史基线</td><td>不是 effort 全矩阵</td><td><span class="status fail">部分</span></td></tr></tbody></table></div></div></section>

<section id="boundary"><div class="shell"><div class="section-head"><div><span class="section-index">06 / OPERATING BOUNDARY</span><h2>选型边界</h2></div></div><div class="boundary"><article><h3><b>Private Flash High</b></h3><p>私密代码、内网数据、稳定日常 SQL/Python/故障诊断。当前默认选择。</p></article><article><h3><b>Private Flash Max</b></h3><p>4K final 覆盖 {pct(bounded['max']['final_coverage'])}；384K 可达 100%，但单题最长 {route_ab['portal']['max_case_seconds'] / 60:.1f} 分钟，仅按请求启用。</p></article><article class="online"><h3><b>Online Pro High</b></h3><p>复杂任务、private 首次失败、需要更高一次成功率。</p></article><article class="online"><h3><b>Pro Max · 按请求</b></h3><p>仅用于极难任务。没有超过 high，token 与分钟级尾延迟显著增加。</p></article></div></div></section>

<section id="evidence"><div class="shell"><div class="section-head"><div><span class="section-index">07 / EVIDENCE</span><h2>方法与证据</h2></div></div><div class="evidence"><ul><li>旧 Private Low/High/Max 均为 effective High；87.5% 不是 Max 精度。</li><li>Portal 修复后，无 override 的 Max 探针与 direct usage、输出哈希一致。</li><li>Private 请求通过 Synology 反代、LLM Portal/LiteLLM 与 WireGuard 到 vLLM，不是直连。</li><li>4K High/Max 各 36 请求；True Max 10/36 截断，High 0/36。</li><li>384K Portal/direct 各 18 请求，均 18/18 stop、0 错误、0 截断。</li><li>Python final 在不可变 ECR sandbox 中评分，原始证据不覆盖。</li><li>快速决策 benchmark：主要精度 n=2；384K route A/B 与 Agent n=1。</li></ul><div class="links"><a href="BENCHMARK-COMPARISON-20260817.md">完整 Markdown 报告 <span>↗</span></a><a href="data/deepseek-private-online-comparison-20260817.json">机器可读汇总 <span>↗</span></a><a href="https://github.com/johnymoo/Nvidia-DGX/pull/32">GitHub PR 32 <span>↗</span></a><a href="https://github.com/shiliai/LLM-Portal/issues/46">LLM Portal Issue 46 <span>↗</span></a></div></div></div></section>
