...
def render_report(project_root: Path, artifact_root: Path, output: Path) -> dict[str, Any]:
    manifest = read_json(project_root / "benchmark" / "tasks.json")
